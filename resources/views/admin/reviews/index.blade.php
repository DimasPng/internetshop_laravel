                                ...
                                <td class="h-px w-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex items-center gap-x-4">
                                            ...
                                            <div>
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Brown Hat</span>
                                            </div>
                                        </div>
                                    </a>
                                </td>
                                ...
                                <td class="h-px w-72 min-w-[18rem] align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex gap-x-1 mb-2">
                                            <svg class="flex-shrink-0 w-3 h-3 text-gray-800 dark:text-gray-200"
                                ...
                                <td class="h-px w-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex items-center gap-x-4">
                                            ...
                                            <div>
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Calvin Klein T-shirts</span>
                                            </div>
                                        </div>
                                    </a>
                                </td>
                                ...
                                <td class="h-px w-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex items-center gap-x-4">
                                            ...
                                            <div>
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Clarks shoes</span>
                                            </div>
                                        </div>
                                    </a>
                                </td>
                                ...
                                <td class="h-px w-72 min-w-[18rem] align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex gap-x-1 mb-2">
                                            ...
                                            <svg class="flex-shrink-0 w-3 h-3 text-gray-400 dark:text-gray-600"
                                                 xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                 fill="currentColor" viewBox="0 0 16 16">
                                                <path
                                                    d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"/>
                                ...
                                <td class="h-px w-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex items-center gap-x-4">
                                            ...
                                            <div>
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Levis women's jeans</span>
                                            </div>
                                        </div>
                                    </a>
                                </td>
                                ...
                                <td class="h-px w-px whitespace-nowrap align-top">
                                    <a class="block p-6" href="#">
                                        <div class="flex items-center gap-x-4">
                                            ...
                                            <div>
                                                <span
                                                    class="block text-sm font-semibold text-gray-800 dark:text-gray-200">Asos T-shirts</span>
                                            </div>
                                        </div>
                                    </a>
                                </td>
